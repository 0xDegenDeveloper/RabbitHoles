...
> `starkli deploy <class_hash> <constructor_args> --account $STARKNET_ACCOUNT --rpc $STARKNET_GOERLI_RPC --keystore $STARKNET_SIGNER`
...
> <constructor_args> == `284853202282316910755836087987553145089895892383786529501944231852568436737` (owner)
...
> <constructor_args> == `1092580785392713095075232812540319657223439146213786134614021612951427494552 99591801629484114175092083 353299420243 6 1000000000 0 284853202282316910755836087987553145089895892383786529501944231852568436737` (manager_address, name, symbol, decimals, initial_supply_lower, initial_supply_upper, receiver)
...
> <constructor_args> == `1092580785392713095075232812540319657223439146213786134614021612951427494552` (manager_address)
